...
<form class="woocommerce-form woocommerce-form-login login" method="post" <?php echo ( esc_attr($hidden) ) ? 'style="display:none;"' : ''; ?>>
	...
	<p class="form-row form-row-first">
		<label for="username"><?php esc_html_e( 'Username or email', 'papr' ); ?>&nbsp;<span class="required">*</span></label>
	...
	<p class="form-row">
		...
		<button type="submit" class="woocommerce-button button woocommerce-form-login__submit" name="login" value="<?php esc_attr_e( 'Login', 'papr' ); ?>"><?php esc_html_e( 'Login', 'papr' ); ?></button>
		<span class="lost_password">
			<a href="<?php echo esc_url( wp_lostpassword_url() ); ?>"><?php esc_html_e( 'Lost your password?', 'papr' ); ?></a>
		</span>
