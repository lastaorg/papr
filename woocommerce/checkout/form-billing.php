...
<div class="woocommerce-billing-fields">
    <?php if (wc_ship_to_billing_address_only() && WC()->cart->needs_shipping()) : ?>
        ...
        <h3><?php esc_html_e('Billing &amp; Shipping', 'papr'); ?></h3>

    <?php else : ?>

        <h3><?php esc_html_e('Billing details', 'papr'); ?></h3>
...
<?php if (!is_user_logged_in() && $checkout->is_registration_enabled()) : ?>
    <div class="woocommerce-account-fields">
        <?php if (!$checkout->is_registration_required()) : ?>
            ...
            <h3 class="form-row form-row-wide create-account login-remember">
                ...
                <label for="createaccount" class="woocommerce-form__label woocommerce-form__label-for-checkbox checkbox">
                    <span><?php esc_html_e('Create an account?', 'papr'); ?></span>
                </label>
            </h3>
