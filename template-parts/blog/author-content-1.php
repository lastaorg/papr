...
$author_content_display = $papr_options['author_content_display'];
//$content = wp_trim_words($content, $papr_options['author_content_number']);
...
<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    <div class="media post-block post-block__mid m-b-xs-30">
        ...
        <div class="media-body">
            ...
            <?php if ($papr_options['author_content_display']) {
                the_excerpt();
            } ?>
        </div>
    </div>
