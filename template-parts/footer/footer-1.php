...
$footer_class_when_redux_false = (!class_exists('Redux')) ? 'footer-thin' : '';
?>

<footer class="page-footer bg-grey-dark-key <?php echo esc_attr($footer_class_when_redux_false); ?>">
    <div class="container">
        <?php if (Helper::axil_active_footer()): ?>
            <div class="footer-top">
                <div class="row">
                    <?php Helper::axil_footer_cal(); ?>
                </div>
                <!-- End of .row -->
            </div>
            <!-- End of .footer-top -->
                    ...
                    <div class="col-md">
                        <div class="footer-logo-container">
                            <a class="footer-logo" href="<?php echo esc_url(home_url('/')); ?>"><img
                                        src="<?php echo esc_url($axil_footer_logo); ?>"
                                ...
                                <div class="footer-social-share">
                                    ...
                                    <ul class="social-share social-share__with-bg">
                                        <?php foreach ($axil_socials as $axil_social): ?>
                                            <li><a target="_blank" href="<?php echo esc_url($axil_social['url']); ?>"><i
